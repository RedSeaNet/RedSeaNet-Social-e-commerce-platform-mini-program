...
class BeLiked extends Component {
  ...
  loadMore = () => {
    ...
    getBeLikes(page + 1, 20).then((data) => {
      data.map((item) => {
        list.push(item);
      });
    });
...
export default connect(mapStateToProps)(BeLiked);
